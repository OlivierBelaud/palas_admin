...
export const formRoutes: FormRouteMap = {
  ...
  "/products/:productId/variants/:id": [
    ...
    { path: "prices", lazy: () => import("@medusa-routes/products/product-prices") },
    { path: "manage-items", lazy: () => import("@medusa-routes/product-variants/product-variant-manage-inventory-items") },
  ...
  "/inventory/:id": [
    ...
    { path: "attributes", lazy: () => import("@medusa-routes/inventory/inventory-detail/components/edit-inventory-item-attributes") },
    ...
    { path: "locations/:location_id", lazy: () => import("@medusa-routes/inventory/inventory-detail/components/adjust-inventory") },
  ],
  ...
  "/settings/tax-regions/:id": [
    ...
    { path: "overrides/:tax_rate_id/edit", lazy: () => import("@medusa-routes/tax-regions/tax-region-tax-override-edit") },
  ...
  "/settings/api-key-management/:id": [
    ...
    { path: "sales-channels", lazy: () => import("@medusa-routes/api-key-management/api-key-management-sales-channels") },
  ],
