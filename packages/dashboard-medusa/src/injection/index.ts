...
const entitiesWithSideZones = [
  "product", "order", "customer", "product_variant", "product_category",
  "price_list", "promotion", "campaign", "location", "reservation",
  "inventory_item",
]

// Entities with only 2 detail zones (before/after, no side)
const entitiesWithoutSideZones = [
  "customer_group", "product_collection", "product_type", "product_tag",
  "shipping_option_type", "user", "region", "shipping_profile",
  "sales_channel", "api_key", "workflow", "tax",
  "store", "profile",
]

// Entities with list zones
const entitiesWithListZones = [
  "product", "order", "customer", "customer_group",
  "product_collection", "product_category", "product_type", "product_tag",
  "shipping_option_type", "price_list", "promotion", "campaign",
  "user", "region", "shipping_profile", "location",
  "sales_channel", "reservation", "api_key", "workflow", "tax",
  "return_reason", "refund_reason", "inventory_item",
]
